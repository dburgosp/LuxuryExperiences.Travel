...
<div class="form-group form-group-<?php echo esc_attr($field_size)?> form-group-icon-left">
    ...
    <div class="st-select-wrapper amd-flight-wrapper" >
        <input <?php echo $is_required; ?> id="location_destination" type="text" class="form-control amd-flight-location st-location-name" autocomplete="off" name="destination" data-name="destination" value="" placeholder="<?php echo esc_html( $placeholder ); ?>">
    </div>
</div>