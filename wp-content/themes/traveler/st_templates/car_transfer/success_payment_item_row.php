...
<tr>
    ...
    <td>
        ...
        <?php } ?>
        <?php endif;?>
        <p><strong><?php echo __('Arrival Date', ST_TEXTDOMAIN) ?>:</strong> <?php echo date(TravelHelper::getDateFormat() . ' H:i:s', strtotime($check_in_time)); ?></p>
        <p><strong><?php echo __('Departure Date', ST_TEXTDOMAIN) ?>:</strong> <?php echo date(TravelHelper::getDateFormat() . ' H:i:s', strtotime($check_out_time)); ?></p>
