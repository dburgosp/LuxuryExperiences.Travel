                    ...
                    if(!empty($transfers)){
                        foreach($transfers as $transfer){
                            if(!empty($transfer['title']) && !empty($transfer['transfer_from']) && !empty($transfer['transfer_to'])){
                                ...
                                self::insert_transfer($car_id, $transfer_from_name . ' - ' . $transfer_to_name, $transfer['transfer_from'], $transfer['transfer_to'], $transfer['return'][0], $transfer['price'], STInput::post('price_type'), STInput::post('num_passenger', 1));
                            }
                        }
                    }
