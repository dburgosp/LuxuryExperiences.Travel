        ...
        function _get_search_result(data){
            if($('.amadeus-content-search').length){
                if (typeof data == 'object') {
                    ...
                    $.getJSON("https://api.sandbox.amadeus.com/v1.2/flights/affiliate-search?apikey="+st_amadeus.apikey+"&origin="+data.origin+"&destination="+data.destination+"&departure_date="+data.departure_date+"&adults="+data.adults+"&currency="+st_amadeus.currency+queryStr, function (ev) {
                        if (typeof ev == 'object') {
