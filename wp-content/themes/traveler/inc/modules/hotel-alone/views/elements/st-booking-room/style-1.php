...
<div id="st-form-booking-room" class="st-form-booking-room style-1">
    <form class="wpbooking-search-form-wrap wpbooking_order_form"  action="<?php echo get_the_permalink(get_the_ID()); ?>">
        ...
        <input name="adult_number" class="form_book_adults"  type="hidden" value="<?php echo STInput::get('adults', 1); ?>">
        <input name="child_number" class="form_book_children"  type="hidden" value="<?php echo STInput::get('children', 0); ?>">
