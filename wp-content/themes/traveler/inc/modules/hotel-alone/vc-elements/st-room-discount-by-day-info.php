<?php
if(!function_exists('hotel_alone_vc_room_discount_by_day_info') && function_exists('vc_map') && function_exists('st_reg_shortcode') && st_check_service_available('st_hotel')) {
