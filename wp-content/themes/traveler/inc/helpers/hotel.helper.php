    ...
    if ( !class_exists( 'HotelHelper' ) ) {
        class HotelHelper
        {
            ...
            public function _format_real_price()
            {
                ...
                $origin_price_result = TravelHelper::format_money( $origin_price + $total_extra * $number_room * $numberday );
                $sale_price_result = TravelHelper::format_money( $sale_price + $total_extra * $number_room * $numberday );
